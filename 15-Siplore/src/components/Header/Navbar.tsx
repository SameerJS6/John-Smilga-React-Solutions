...
export default function Navbar({}: Props) {
  let detailsRef: React.RefObject<HTMLDetailsElement> = useRef(null);
  ...
  return (
    <nav className="navbar bg-base-200 px-4 xl:px-32">
      ...
      <div className="flex-none hidden lg:flex">
        <ul className="menu menu-horizontal px-1 gap-4 items-center">
          ...
          <li>
            <Dropdown downRef={detailsRef} />
            {/* <details ref={detailsRef} className="dropdown">
              <summary className="m-1 btn place-content-center btn-ghost">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-lg max-w-sm">
                <li>
                  <a className="rounded-md">Item 1</a>
                </li>
                <li>
                  <a className="rounded-md">Item 2</a>
                </li>
              </ul>
            </details> */}
          </li>
          ...
          <li>
            <a
              ...
              target="_blank"
              className="btn btn-square place-content-center"
            >
              <svg
                width="20"
                height="20"
