...
export default function Navbar({}: Props) {
  ...
  return (
    <header data-overlay={isOpen} className="navbar bg-base-200 px-4 xl:px-32">
      ...
      >
        ...
        <ul className="menu menu-horizontal px-1 gap-2 lg:gap-4 items-center">
          <li>
            <CustomLink
              onClick={closeMenu}
              className="max-lg:btn-ghost"
              pathTo="/"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a
              ...
              target="_blank"
              className="max-lg:btn-ghost btn lg:indent-[-9999px] lg:btn-square lg:gap-0 place-content-center"
            >
              <svg
                width="20"
                height="20"
