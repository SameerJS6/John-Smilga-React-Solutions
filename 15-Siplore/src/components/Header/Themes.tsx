...
// const Themes: string[] = ['light', "dark", "cupcake", "lofi", "black"]
...
export default function Themes({}: Props) {
  ...
  return (
    <details ref={DropDownRef} className="dropdown max-lg:ml-6">
      <summary
        ref={ripple}
        onMouseDown={event}
      ...
      <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-200 rounded-lg max-w-md">
        <li>
          <button className="bg-base-100 rounded-md capitalize text-base font-medium">
