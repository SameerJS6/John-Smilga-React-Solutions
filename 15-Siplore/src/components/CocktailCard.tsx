...
export default function CocktailCard({
  ...
  return (
    <article className="slide-top card max-[400px]:card-compact w-full bg-base-200 shadow-xl rounded-3xl active:rounded-[2.5rem] active:scale-[99%] active:-translate-y-1 transition-all">
      <figure>
        <img
          src={DrinkImage}
