...
export default function Modal() {
  ...
  return (
    <>
      <article className="fixed left-1/2 top-1/2 z-10 grid -translate-x-1/2 -translate-y-1/2 justify-center rounded-xl bg-white p-4 shadow-xl transition-all duration-300 sm:p-8">
